...
public class DecafOLC2Parser extends Parser {
	...
	public static final int
		...
		T__52=53, INT_LIT=54, FLOAT_LIT=55, CHAR_LIT=56, STRING_LIT=57, IDENT=58, 
		WS=59, LINE_COMMENT=60, COMMENT=61, PLUS=62, MINUS=63, STAR=64, DIV=65, 
		MOD=66;
	public static final int
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			null, null, null, null, null, null, null, null, null, null, null, null, 
			null, null, null, null, null, null, null, null, null, null, null, null, 
			null, null, null, null, null, null, "INT_LIT", "FLOAT_LIT", "CHAR_LIT", 
			"STRING_LIT", "IDENT", "WS", "LINE_COMMENT", "COMMENT", "PLUS", "MINUS", 
			"STAR", "DIV", "MOD"
		};
	}
	...
	public final ClaseDeclContext claseDecl() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 288230376159705152L) != 0)) {
				{
				{
				setState(94);
				miembroClase();
	...
	public final ConstructorDeclContext constructorDecl() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 288230376151838720L) != 0)) {
				{
				setState(153);
				params();
				}
	...
	public final BloqueContext bloque() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & -4036069686901734872L) != 0)) {
				{
				{
				setState(216);
				sentencia();
	...
	public final SentenciaContext sentencia() throws RecognitionException {
		...
		try {
			...
			case T__24:
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
				if ((((_la) & ~0x3f) == 0 && ((1L << _la) & -4036069691054095872L) != 0)) {
					{
					setState(235);
					expr();
					}
	...
	public final ForStmtContext forStmt() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & -4036069691046104512L) != 0)) {
				{
				setState(270);
				forInit();
				}
	...
	public static class AditivoExprContext extends ParserRuleContext {
		...
		public List<TerminalNode> PLUS() { return getTokens(DecafOLC2Parser.PLUS); }
		public TerminalNode PLUS(int i) {
			return getToken(DecafOLC2Parser.PLUS, i);
		}
		public List<TerminalNode> MINUS() { return getTokens(DecafOLC2Parser.MINUS); }
		public TerminalNode MINUS(int i) {
			return getToken(DecafOLC2Parser.MINUS, i);
		}
	...
	public static class MultExprContext extends ParserRuleContext {
		...
		public List<TerminalNode> STAR() { return getTokens(DecafOLC2Parser.STAR); }
		public TerminalNode STAR(int i) {
			return getToken(DecafOLC2Parser.STAR, i);
		}
		public List<TerminalNode> DIV() { return getTokens(DecafOLC2Parser.DIV); }
		public TerminalNode DIV(int i) {
			return getToken(DecafOLC2Parser.DIV, i);
		}
		public List<TerminalNode> MOD() { return getTokens(DecafOLC2Parser.MOD); }
		public TerminalNode MOD(int i) {
			return getToken(DecafOLC2Parser.MOD, i);
		}
	...
	public static class UnaryExprContext extends ParserRuleContext {
		...
		public TerminalNode PLUS() { return getToken(DecafOLC2Parser.PLUS, 0); }
		public TerminalNode MINUS() { return getToken(DecafOLC2Parser.MINUS, 0); }
